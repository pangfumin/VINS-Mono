#include "spline_vio/spline/spline_projection_error7.h"
#include "spline_vio/spline/QuaternionSplineUtility.hpp"
#include "spline_vio/spline/PoseLocalParameter.hpp"

SplineProjectError7::SplineProjectError7(const SplineProjectFunctor7& functor):
functor_(functor){}


bool SplineProjectError7::Evaluate(double const *const *parameters,
                                   double *residuals,
...
bool SplineProjectError7::EvaluateWithMinimalJacobians(double const *const *parameters,
                                                       double *residuals,
                                                       double **jacobians,
    ...
    if (!jacobians) {
        return ceres::internal::VariadicEvaluate<
                SplineProjectFunctor7, double, 7, 7, 7, 7, 7, 7, 7, 1,1,0>
    ...
    bool success =  ceres::internal::AutoDiff<SplineProjectFunctor7, double,
