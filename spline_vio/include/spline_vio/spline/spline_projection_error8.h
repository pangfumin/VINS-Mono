...
#ifndef SPLINE_PROJECT_FACTOR8_H
#define SPLINE_PROJECT_FACTOR8_H
#include <vector>
#include <mutex>
...
struct SplineProjectFunctor8{
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    SplineProjectFunctor8(const double _t0, const Eigen::Vector3d& uv_C0,
...
class SplineProjectError8{

public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW

    SplineProjectError8() = delete;
    SplineProjectError8(const SplineProjectFunctor8& functor);

    /// \brief Trivial destructor.
    virtual ~SplineProjectError8() {}
...
private:
    SplineProjectFunctor8 functor_;
};
