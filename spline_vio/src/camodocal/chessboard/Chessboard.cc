#include "spline_vio/camodocal/chessboard/Chessboard.h"

#include <opencv2/calib3d/calib3d.hpp>
#include <opencv2/imgproc/imgproc.hpp>

#include "spline_vio/camodocal/chessboard/ChessboardQuad.h"
#include "spline_vio/camodocal/chessboard/Spline.h"
