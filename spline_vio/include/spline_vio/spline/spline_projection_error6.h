...
#ifndef SPLINE_PROJECT_FACTOR6_H
#define SPLINE_PROJECT_FACTOR6_H
#include <vector>
#include <mutex>
...
struct SplineProjectFunctor6{
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    SplineProjectFunctor6(const double _t0, const Eigen::Vector3d& uv_C0,
...
class SplineProjectError6{

public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW

    SplineProjectError6() = delete;
    SplineProjectError6(const SplineProjectFunctor6& functor);

    /// \brief Trivial destructor.
    virtual ~SplineProjectError6() {}
...
private:
    SplineProjectFunctor6 functor_;
};
