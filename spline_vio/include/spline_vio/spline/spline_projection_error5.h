...
#ifndef SPLINE_PROJECT_FACTOR5_H
#define SPLINE_PROJECT_FACTOR5_H
#include <vector>
#include <mutex>
...
struct SplineProjectFunctor5{
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    SplineProjectFunctor5(const double _t0, const Eigen::Vector3d& uv_C0,
...
class SplineProjectError5{

public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW

    SplineProjectError5() = delete;
    SplineProjectError5(const SplineProjectFunctor5& functor);

    /// \brief Trivial destructor.
    virtual ~SplineProjectError5() {}
...
private:
    SplineProjectFunctor5 functor_;
};
