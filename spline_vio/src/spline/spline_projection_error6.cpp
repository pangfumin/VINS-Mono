#include "spline_vio/spline/spline_projection_error6.h"
#include "spline_vio/spline/QuaternionSplineUtility.hpp"
#include "spline_vio/spline/PoseLocalParameter.hpp"

SplineProjectError6::SplineProjectError6(const SplineProjectFunctor6& functor):
functor_(functor){}


bool SplineProjectError6::Evaluate(double const *const *parameters,
                                   double *residuals,
...
bool SplineProjectError6::EvaluateWithMinimalJacobians(double const *const *parameters,
                                                       double *residuals,
                                                       double **jacobians,
    ...
    if (!jacobians) {
        return ceres::internal::VariadicEvaluate<
                SplineProjectFunctor6, double, 7, 7, 7, 7, 7, 7, 1,1,0,0>
    ...
    bool success =  ceres::internal::AutoDiff<SplineProjectFunctor6, double,
