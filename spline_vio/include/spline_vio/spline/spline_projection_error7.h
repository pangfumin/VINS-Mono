...
#ifndef SPLINE_PROJECT_FACTOR7_H
#define SPLINE_PROJECT_FACTOR7_H
#include <vector>
#include <mutex>
...
struct SplineProjectFunctor7{
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    SplineProjectFunctor7(const double _t0, const Eigen::Vector3d& uv_C0,
...
class SplineProjectError7{

public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW

    SplineProjectError7() = delete;
    SplineProjectError7(const SplineProjectFunctor7& functor);

    /// \brief Trivial destructor.
    virtual ~SplineProjectError7() {}
...
private:
    SplineProjectFunctor7 functor_;
};
